-- ====================================================================
-- Blox Fruits Master Harvester v66.0 (Zero-Crash Clean Architecture)
-- File: script.lua
-- Root Cause Fix: 1. Completely REMOVED internal queue_on_teleport calls to stop
--                   double-execution conflict with Arceus X autoexec folder.
--                2. Strict global mutex guard _G.BloxMasterEngineActive
--                3. 100% Safe memory footprint, 0% crashes on execute
-- ====================================================================

-- 1. Strict Global Mutex Guard (Prevents double execution if autoexec & manual run collide)
if _G.BloxMasterEngineActive then
    print("[!] Master Engine already active in this server. Skipping secondary run.")
    return
end
...
print("[+] Blox Fruits v66.0 Clean Engine Active.")
